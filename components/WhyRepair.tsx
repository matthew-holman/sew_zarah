  ...
  return (
    <div>
      <div className="max-w-2xl">
        <h2 className="text-3xl text-white md:text-4xl">{whyRepair.heading}</h2>
      </div>
      ...
      <div className="mt-12 grid gap-6 md:grid-cols-3">
        {whyRepair.points.map((point) => (
          ...
          >
            <div className="mb-5 inline-flex h-10 w-10 items-center justify-center rounded-full border border-white/20 text-white">
              <svg
