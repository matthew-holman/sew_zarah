        ...
        <div>
            <div className="max-w-2xl">
                ...
                <p className="mt-4 text-lg text-white/70">
                    Share a short description and 1–3 photos. We’ll confirm if the repair is
                    possible and reply with an estimated price range.
                </p>
            </div>
            ...
            <div className="mt-10 rounded-3xl bg-black/10 p-8 ring-1 ring-white/25">
                <form className="grid gap-4 md:grid-cols-2">
                    ...
                    <label className="flex flex-col gap-2 text-sm text-white/70 md:col-span-2">
                        What needs repairing? <span className="text-white/40">(required)</span>
                        <textarea
                    ...
                    <label className="flex flex-col gap-2 text-sm text-white/70 md:col-span-2">
                        Upload photos <span className="text-white/40">(1–3 images, JPG/PNG)</span>
                        <input
              ...
              Please include the area that needs repair and one full-item photo if possible.
            </span>
                    </label>

                    <fieldset className="flex flex-col gap-3 text-sm text-white/70 md:col-span-2">
